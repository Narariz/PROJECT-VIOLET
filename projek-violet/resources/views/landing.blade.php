        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
            <div class="row gy-4">
              ...
              <div class="col-lg-6">
                <img src="/img/gambar 6.png" class="img-fluid" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="pricing-item">
              ...
              <ul>
                ...
                <li><i class="bi bi-check"></i> <span>Laporan Lengkap</span></li>
                <li><i class="bi bi-check"></i> <span>Pencatatan Keuangan</span></li>
                <li><i class="bi bi-check"></i> <span>Manajemen Karyawan</span></li>
                <li><i class="bi bi-check"></i> <span>CRM</span></li>
                <li><i class="bi bi-check"></i> <span>Digital Payment(QRIS)</span></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="pricing-item featured">
              ...
              <h3>Prime</h3>
              <p class="description">Untuk semua jenis usaha. Penjualan, keuangan, dan karyawan.</p>
              <h4><sup>Rp</sup>999.000</h4>
              <a href="#" class="cta-btn">Pilih Paket</a>
              <ul>
                <li><i class="bi bi-check"></i> <span>Multi outlet</span></li>
                <li><i class="bi bi-check"></i> <span>Toko Online: Website, Webtree, Weborder, Opsi Premium Domain, Shopee, Tokopedia, Grabmart, Multiakun Marketplace Omnichannel</span></li>
                <li><i class="bi bi-check"></i> <span>Aplikasi Kasir Online: Atur meja, Multisatuan, Reservasi & Produk Jasa, Leveling Komisi, Serial Number, Batch Number, Grosir</span></li>
                <li><i class="bi bi-check"></i> <span>Laporan Lengkap: Analisa bisnis</span></li>
                <li><i class="bi bi-check"></i> <span>Aplikasi Owner</span></li>
                <li><i class="bi bi-check"></i> <span>Order Online: Weborder, QR Emenu, Grabfood, Gofood</span></li>
                <li><i class="bi bi-check"></i> <span>Pencatatan Keuangan: BI, Tax, Keuangan Bank, E-banking, Insentif pajak</span></li>
                <li><i class="bi bi-check"></i> <span>Manajemen Karyawan: HRD</span></li>
                <li><i class="bi bi-check"></i> <span>CRM: Kontrol kebijakan</span></li>
                <li><i class="bi bi-check"></i> <span>Digital Payment(QRIS): Retail, Online, Payment</span></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="pricing-item">
              <h3>Enterprise</h3>
              <p class="description">Untuk semua jenis usaha. Pencatatan keuangan hingga manajemen karyawan.</p>
              <h4><sup>Rp</sup>1.999.000</h4>
              <a href="#" class="cta-btn">Pilih Paket</a>
              <ul>
                <li><i class="bi bi-check"></i> <span>Multi outlet</span></li>
                <li><i class="bi bi-check"></i> <span>Toko Online: Website, Webtree, Weborder, Opsi Premium Domain, Shopee, Tokopedia, Grabmart, Multiakun Marketplace Omnichannel</span></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5" data-aos="fade-right">
            <h2>Hubungi Kami</h2>
            <p>Jika ada pertanyaan atau informasi lebih lanjut, silakan hubungi kami melalui formulir di bawah ini.</p>
          </div>
